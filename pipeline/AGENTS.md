...
- Keep Actions scanner admission disabled whenever the transactional Monica wrapper is unavailable or quiesced, so remote ready packets cannot accumulate without a verified consumer.
