...
def validate_draft(draft, packet):
    ...
    # Images are supplied by the operator/source intake, or generated by news_mvp/imagery.py.
    # Never invented by the writer model: the draft must carry exactly the packet's record.
