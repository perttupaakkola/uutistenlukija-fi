---
title: "Häätöjen määrä kasvoi Suomessa, mutta väheni kokeilukaupungeissa"
date: 2026-08-23T03:26:47.673060+00:00
categories:
  - Kotimaa
author: "Toimitus"
author_id: "toimitus"
...
key_points:
  ...
  - "Ville Kupiainen oli oman häätönsä jälkeen asunnoton noin kolme vuotta."
journalist_note: |
  Artikkeli käyttää vain ehjiä aineistokatkelmia. Viimeinen kesken katkennut Lahtea koskeva katkelma jätettiin väitteiden ulkopuolelle.
content_type: "article"
editorial_reviewed: true
image: "/images/categories/kotimaa.jpg"
image_thumb: "/images/categories/kotimaa.jpg"
image_alt: "Kuvituskuva uutiseen: Häätöjen määrä kasvoi Suomessa, mutta väheni kokeilukaupungeissa (häädöt, asunnottomuus)"
...
source_url: "https://yle.fi/a/74-20242123?origin=rss"
source_domain: "yle.fi"
source_attributions:
  - name: "Yle Uutiset"
    url: "https://yle.fi/a/74-20242123?origin=rss"
briefing: true
draft: false
---
...
Ville Kupiainen menetti ensimmäisen oman vuokra-asuntonsa seitsemän vuotta sitten. Häädön taustalla olivat maksamattomat vuokrat ja häiriökäyttäytyminen. Kupiainen kertoo nuoruutensa kuluneen alkoholin, huumeiden ja lääkkeiden parissa. Hän sai tuolloin asumis- ja toimeentulotukea, mutta rahat eivät päätyneet vuokraan, vaan päihteisiin.

Häädön jälkeen Kupiainen oli asunnoton noin kolme vuotta. Hän yöpyi ajoittain ystävien ja sukulaisten luona ja etsi seuraavaa majapaikkaa. Hänen mukaansa elämä oli häädön aikaan niin sekaisin, ettei kodin menetys aluksi juuri tuntunut. Myöhemmin asunnottomuudesta tuli hänelle normaalilta vaikuttava olotila. Väliaikaiset yöpaikat eivät muodostaneet pysyvää kotia, vaan arki rakentui selviytymisen varaan.

Häätöjä ehkäisevässä työssä Ulosottolaitos on koonnut pilottikaupungeissa yhteen suuria vuokranantajia, kaupunkien asumisneuvontaa, hyvinvointialueiden aikuissosiaalityötä, nuorisopalveluja ja talousneuvontaa tarjoavia tahoja. Kumppanit etsivät yhdessä keinoja häätöjen estämiseksi. Tavoitteena on tunnistaa vuokravelat ajoissa, lisätä tietoa häätöprosessista ja puuttua tilanteeseen ennen asunnon menettämistä.
